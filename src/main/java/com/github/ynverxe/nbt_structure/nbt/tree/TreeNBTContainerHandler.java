...
import com.github.ynverxe.nbt_structure.nbt.TagScheme;
...
public class TreeNBTContainerHandler implements NBTContainer {
    ...
    @Override
    public <I, N extends NBT<?>> I interpret(@NotNull TagScheme<I, N> tagScheme) {
        N nbt = read(tagScheme);

        if (nbt == null) return null;

        return tagScheme.interpretValue(nbt).orElse(null);
    }
