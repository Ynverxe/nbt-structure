...
public class TreeNBTContainerHandler implements NBTContainer {
  ...
  private static final BiFunction<TreeNBTContainer, String, Object> TREE_VALUE_SEARCHER =
      NBTReadable::read;

  private static final BiConsumer<TreeNBTContainer, Map.Entry<String, Object>>
      PHANTOM_TREE_MUTATOR = (treeNBTContainer, entry) -> {};
  private static final BiConsumer<TreeNBTContainer, Map.Entry<String, Object>> TREE_MUTATOR =
      (treeNBTContainer, entry) -> treeNBTContainer.write(entry.getKey(), entry.getValue());

  private static final Supplier<TreeNBTContainer> PHANTOM_CREATOR = () -> null;
  private static final Function<TreeNBTContainer, Supplier<TreeNBTContainer>> BRANCH_CREATOR =
      treeNBTContainer -> treeNBTContainer::createNewBranch;
